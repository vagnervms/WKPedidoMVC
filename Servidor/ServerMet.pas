...
uses System.SysUtils, System.Classes, System.Json, Variants,
    DataSnap.DSProviderDataModuleAdapter, FireDAC.Stan.Intf, Vcl.Forms,
...
begin
  ...
  Banco.Params.Values['User_name']:= GetParms('Usuario');
  Banco.Params.Values['Password'] := GetParms('Senha');
  Banco.Params.Values['Port']     := GetParms('Porta');
  FDPDriver.VendorLib:= ExtractFilePath(Application.ExeName)+'libmysql.dll';
end;
